...
extension DependencyValues {
    public var eventKitManager: EventKitManager {
...
public final actor EventKitManager {
    ...
    @discardableResult
    public func accessEventsCalendar() async throws -> EKCalendar {
        try await eventsAvailabilityCheck()
    ...
    /// - Returns: calendar object
    @discardableResult
    public func accessRemindersCalendar() async throws -> EKCalendar {
        try await remindersAvailabilityCheck()
